            ...
            try
            {
                ...
                if (patient != null)
                {
                    ...
                    if(PopUp.DialogResult == System.Windows.Forms.DialogResult.OK)
                    {
                        ...
                        string path = @"PATHTOSAVEFOLDER\ExportDB.xml"; //Ändra till var man vill spara databasen
                        //string pathBackUp = "G:/SU.Omr4.MFT.TSF/Pågående projekt/Database Intressanta Fall/ExportDB.xml"; // Hitta en mapp för back upen som nås av alla
                        ...
                        if (PopUp.Plan_index == -1) //om ingen plan har valts, hitta ordinationen i Aria databasen
                        {
                            ...
                            {
                                Ordination = prescription.Targets.First().DosePerFraction + " x " + prescription.Targets.First().NumberOfFractions; // Antar att första target i ordinationen är huvudtarget
                            }
                            else
                            {
                                Ordination = "None";
                        ...
                        else //om en plan har valts, ta dos per fx och slutdos från planen i Eclipse
                        {
                        ...
                        db.Add(new XElement("NewCase",
                                   ...
                                   new XElement("Datum", DateTime.Today.ToShortDateString()),
